...
Registering a project is also what makes its ship work happen in the captain's own directory rather than in a disposable copy, whichever posture it carries, so tell him that when he registers one.
`AGENTS.md` section 7 owns that rule and what lifts it.
